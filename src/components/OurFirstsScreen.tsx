...
const TIMELINE = [
  {
    ...
    prompt: 'What did you feel when you first reached out — or when I first reached out to you across this distance?',
    hint: 'Nervous, curious, not knowing where it would go…',
  ...
  },
  {
    ...
    prompt: 'What did you notice about me in the way we talked — even through a screen? What surprised you?',
    hint: 'Something in the words, the energy, the way time stopped mattering…',
  ...
  },
  {
    ...
    prompt: 'When did you first smile because of something I said or did — even on a call? What was it?',
    hint: 'Even a small thing you remember now…',
  ...
  },
  {
    ...
    prompt: 'When did you first notice yourself missing me — not just wishing we could talk, but actually aching for me?',
    hint: 'Something reminded you. Where were you?',
  ...
  },
  {
    ...
    prompt: 'The first time you knew this wasn\'t just two people texting across the world. Describe the exact moment.',
  ...
  },
  {
    ...
    prompt: 'What was that moment like for you? What did it feel like to know what we were — despite the miles?',
    hint: 'Not the words — the feeling in your heart when everything became real…',
