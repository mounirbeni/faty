...
const MOMENTS = [
  {
    ...
    prompt: 'What crossed your heart in that very first moment?',
  ...
  },
  {
    ...
    prompt: 'What made you want to keep going?',
    hint: 'Something about the words, the feeling, the quiet after…',
    glow: 'rgba(167,139,250,0.18)',
  },
  {
    icon: '✨',
    title: 'The moment I realized you were different…',
    prompt: 'What changed inside you? What did you finally see?',
  ...
  },
  {
    ...
    prompt: 'What were you feeling? What wouldn\'t leave your mind?',
    hint: 'Let yourself remember it exactly as it was',
    glow: 'rgba(99,102,241,0.18)',
  },
  {
    icon: '💗',
    title: 'The moment I knew I had real feelings…',
    prompt: 'Describe exactly what happened in your heart.',
  ...
  },
  {
    ...
    prompt: 'What were you doing? What did it feel like to finally know?',
