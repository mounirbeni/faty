...
const DIMENSIONS = [
  {
    ...
    question: 'The city where we finally stop being apart and start being together…',
    options: [
      { label: 'Wherever you are — I\'ll come to you, no conditions', icon: '🛫' },
      { label: 'A new city, chosen together — neither of our old lives', icon: '🗺️' },
      { label: 'We figure it out one step at a time — the city doesn\'t matter', icon: '🧭' },
      { label: 'Wherever I can wake up next to you is already home', icon: '💗' },
    ],
  },
  {
    id: 'wedding',
    icon: '💍',
    title: 'Our Wedding',
    question: 'How I see us beginning forever — after all the waiting…',
    options: [
      { label: 'Intimate — just the people who knew we\'d make it', icon: '🕯️' },
      { label: 'Something beautiful we planned together, worth every mile', icon: '🌸' },
      { label: 'Simple, honest, and completely ours', icon: '✦' },
  ...
  },
  {
    ...
    icon: '👨‍👩‍👧',
    title: 'Our Family',
    question: 'What I dream our love will build once we\'re finally in the same place…',
    options: [
      { label: 'Children who grow up knowing exactly what real love looks like', icon: '🌱' },
      { label: 'A small family, warm and full and ours', icon: '🔥' },
      { label: 'Whatever comes — as long as we face it from the same room', icon: '🤝' },
  ...
  },
  {
    id: 'everyday',
    icon: '☀️',
    title: 'Our First Ordinary Morning',
    question: 'What the first morning we don\'t have to say goodbye looks like…',
    options: [
      { label: 'Coffee in silence — just existing in the same room without needing to speak', icon: '☕' },
      { label: 'Chaos and laughter and figuring out who showers first', icon: '😂' },
      { label: 'Me watching you sleep for a moment, just to make sure it\'s real', icon: '🌷' },
      { label: 'Completely ordinary — and that\'s exactly what makes it perfect', icon: '🫂' },
    ],
  },
  {
    id: 'forever',
    icon: '∞',
    title: 'Our Forever',
    question: 'What I believe this love becomes when the distance is just a memory…',
    options: [
      { label: 'Something deeper and more beautiful than either of us can currently imagine', icon: '🌌' },
      { label: 'A love that got stronger because of every hard day apart', icon: '📈' },
      { label: 'A story I want to tell our children — how we crossed the distance for each other', icon: '📖' },
      { label: 'Everything I have ever wanted from one person', icon: '🌹' },
    ],
  },
];
