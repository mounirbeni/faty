    ...
    <motion.div key="hub" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <div className="rounded-[20px] p-4 mb-1" style={{ background: '#120F1C', border: '1px solid rgba(255,255,255,0.08)' }}>
        <p className="text-[13px] leading-relaxed" style={{ color: 'rgba(255,255,255,0.7)' }}>
          My love, everything in here is from me to you. When Meknès feels too far from Marrakech and I can’t hold you, come here — I left pieces of myself waiting for you. 🤍
        </p>
      </div>
      {cards.map((c, i) => (
