...
export const questionsData: Question[] = [
  ...
  { id: 2, category: 1, categoryName: 'Meeting May 11 & Expectations', type: 'choice', question: 'Do you prefer our first meeting to be in...?', options: ['A public and crowded place so you feel comfortable', 'A quiet place that allows for deep conversation', 'A long walking tour through the streets of Meknes'] },
  ...
  { id: 4, category: 1, categoryName: 'Meeting May 11 & Expectations', type: 'choice', question: 'If you suddenly feel awkward while we are sitting together, what would you prefer I do?', options: ['Change the subject to something funny', 'Give you some comfortable silence', 'Ask you directly if you are okay'] },
  ...
  { id: 8, category: 1, categoryName: 'Meeting May 11 & Expectations', type: 'choice', question: 'How do you prefer we end our first meeting?', options: ['A quick, smiling goodbye', 'A warm hug', 'Sitting for a moment just looking at each other before leaving'] },
  ...
  { id: 14, category: 2, categoryName: 'How You See Me', type: 'choice', question: 'What trait of mine makes you feel most comfortable with me?', options: ['How you listen and accept my thoughts', 'Your calm tone of voice', 'Your ability to make me laugh', 'Your honesty and absolute clarity'] },
  ...
  { id: 18, category: 2, categoryName: 'How You See Me', type: 'choice', question: 'If you wished I expressed something more in our relationship, what would it be?', options: ['Expressing your feelings more clearly', 'Sharing more details of your day with me', 'Taking the initiative to check on me more often', 'Showing the fun and crazy side of your personality'] },
  { id: 19, category: 2, categoryName: 'How You See Me', type: 'choice', question: 'How do you view my way of handling stress and problems?', options: ['You handle them calmly and rationally', 'You get a bit tense but always find solutions', 'You isolate yourself and need space'] },
  ...
  { id: 23, category: 3, categoryName: 'Boundaries & Physical Space', type: 'choice', question: 'If I make a spontaneous physical gesture and you feel uncomfortable, how will you react?', options: ['I will tell you gently and directly', 'I will step back slightly so you get the hint', 'I will stay quiet to avoid awkwardness'] },
  ...
  { id: 25, category: 3, categoryName: 'Boundaries & Physical Space', type: 'choice', question: 'Do you consider the idea of a "first kiss" early in the relationship to be...?', options: ['Way too early and unacceptable right now', 'Depends entirely on the moment and comfort level', 'A necessary romantic step to build chemistry'] },
  ...
  { id: 27, category: 3, categoryName: 'Boundaries & Physical Space', type: 'choice', question: 'If you are upset with me, how do you prefer I calm you down?', options: ['With a gentle touch like holding my hand', 'With logical words and practical solutions', 'By stepping away and giving me space to calm down'] },
  ...
  { id: 29, category: 3, categoryName: 'Boundaries & Physical Space', type: 'choice', question: 'Are you comfortable if I express admiration for your physical details and appearance right now?', options: ['Yes, that makes me very happy', 'I accept it if it is classy and respectful', 'No, I prefer focusing on my mind and personality for now'] },
  ...
  { id: 31, category: 4, categoryName: 'Emotional Needs & Conflict', type: 'choice', question: 'What is your usual way of expressing anger or upset?', options: ['Exploding and arguing to release energy', 'Complete silence and ignoring the other person', 'Discussing it calmly after some time has passed'] },
  ...
  { id: 33, category: 4, categoryName: 'Emotional Needs & Conflict', type: 'choice', question: 'If we disagree on an important topic, how do you prefer we handle the discussion?', options: ['Start by validating my opinion before sharing yours', 'Discussing it logically without emotion', 'Taking a timeout to calm down first'] },
  ...
  { id: 35, category: 4, categoryName: 'Emotional Needs & Conflict', type: 'choice', question: 'What is the most important "Love Language" for you to feel cared for?', options: ['Hearing words of love and appreciation', 'Receiving thoughtful gifts', 'Quality time together', 'Acts of service and practical support'] },
  ...
  { id: 37, category: 4, categoryName: 'Emotional Needs & Conflict', type: 'choice', question: 'When are you in your most vulnerable psychological state?', options: ['When daily pressures and tasks pile up', 'When feeling disappointed by someone close to me', 'When I lack a sense of security and stability'] },
  ...
  { id: 39, category: 4, categoryName: 'Emotional Needs & Conflict', type: 'choice', question: 'If the attention between us started to fade or become routine, what would you do?', options: ['I would be direct and ask for attention', 'I would reduce my attention as a reaction', 'I would take the initiative to break the routine myself'] },
  ...
  { id: 42, category: 5, categoryName: 'Compatibility & Future', type: 'choice', question: 'How do you view privacy between us (like phones and messages)?', options: ['Absolute transparency, no secrets', 'Everyone has their privacy that must be respected', 'We share what we want, but without snooping or suspicion'] },
  ...
  { id: 44, category: 5, categoryName: 'Compatibility & Future', type: 'choice', question: 'What is the acceptable limit of jealousy for you?', options: ['I love obvious jealousy, it makes me feel valued', 'I accept rational jealousy that doesn\'t restrict my freedom', 'I hate jealousy and consider it a lack of trust'] },
  ...
  { id: 48, category: 5, categoryName: 'Compatibility & Future', type: 'choice', question: 'If we had to decide where to settle down in the future, what matters most to you?', options: ['Being close to my family and city', 'Career opportunities and quality of life', 'Living in a calm and peaceful city'] },
