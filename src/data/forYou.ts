...
export const OPEN_WHEN: OpenWhenLetter[] = [
  {
    ...
    body: 'Hey Faty. Stop fighting the dark — I’m right here with you in it, even with all of Marrakech and Meknès between us. Close your eyes and picture my arm around you, your back against my chest, my breath slow against your neck, exactly like those nights I was there. Match your breathing to that. You don’t have to carry tonight by yourself.',
    signoff: 'Now sleep, Faty. I’ll see you in your dreams. 🌙',
  },
  {
  ...
  },
  {
    ...
    body: 'Come here, Faty. You don’t have to be strong for me — put it all down for a minute. Whatever happened today, it doesn’t get to decide how loved you are. You’re still the best thing in my life. Tomorrow gets a fresh start, and you won’t face it alone. Tell me everything when you’re ready. I’m listening.',
    signoff: 'You’re safe with me. Always. 🤍',
  },
  {
    id: 4, emoji: '😟', when: 'you feel insecure about us',
    body: 'Read this slowly, Faty. There is no version of this where I leave. I’m not going anywhere, I’m not looking anywhere else, and I don’t want anyone but you. Meknès to Marrakech is just kilometres — it can’t touch what we have. The doubt in your head is lying to you. I chose you, I keep choosing you, and I’ll choose you tomorrow too.',
    signoff: 'It’s you. It was always going to be you. 💍',
  },
  {
    id: 5, emoji: '🥺', when: 'you need to feel loved',
    body: 'Then let me remind you, Faty. You are loved — deeply, stubbornly, completely. Loved on your good days and your hard ones. Loved when you’re glowing and when you’re a mess. There is nothing you need to do to earn it. You already have all of me, exactly as you are right now.',
    signoff: 'Every bit of me is yours. 🌹',
  },
  {
    id: 6, emoji: '😤', when: 'you’re upset with me',
    body: 'I’d rather have you angry and honest than quiet and far away. Whatever I did, you matter more to me than being right. I’m not going anywhere while we figure it out — not the distance, not a bad night, nothing. Take your space if you need it, but come back to me. We’re on the same team, Faty, even when it doesn’t feel like it.',
    signoff: 'I’m sorry, and I’m still here. 🤝',
  },
  {
    id: 7, emoji: '✨', when: 'you need to smile',
    body: 'Okay, smile-emergency mode. Remember how you laugh at your own jokes before you even finish them? I think about that constantly. You’re ridiculous and adorable and I’m completely obsessed with you. There — I saw that little smile start. Don’t fight it, Faty. You’re cute when you give in. 😏',
    signoff: 'Caught you smiling. Mission complete. 😄',
  },
  {
    id: 8, emoji: '🔥', when: 'you want to feel wanted',
    body: 'Wanted? Faty, you have no idea. I still replay those 3 days in Meknès more than I’ll admit — the way you looked at me, your voice late at night, everything I didn’t want to stop. You’re not just loved, you’re craved. The next time there’s no screen and no distance between us, you’ll feel exactly how much.',
    signoff: 'Counting down to no more distance. 🔥',
  },
  {
    id: 9, emoji: '🌅', when: 'it’s a brand new morning',
    body: 'Good morning, Faty. Before Meknès and the whole day grab you — I love you. That’s the first thing and the truest thing. Go be brilliant, eat something, drink water, and know that someone all the way in Marrakech is already proud of you and thinking about your face.',
    signoff: 'Have the day you deserve. ☀️',
  },
  {
    id: 10, emoji: '💞', when: 'you wonder about our future',
    body: 'Let me paint it for you, Faty. No more 380-kilometre goodbye at the end of a visit. Lazy mornings in one home. A kitchen that smells like us. Stupid arguments about whose turn it is, ending in laughing. Falling asleep in the same bed and waking up still tangled. Those 3 days were just a preview — the real story is coming.',
...
export const LOVE_REASONS: string[] = [
  'The way your whole face changes when you really laugh, Faty.',
...
export const LOVE_COUPONS: LoveCoupon[] = [
  ...
  { id: 5, emoji: '🎙️', title: 'Bedtime Voice Note', detail: 'A voice note of me talking you to sleep, just for you, Faty.' },
