...
const CINEMATIC: Record<string, string> = {
  ...
  'intimacy-hub':      '🔥 Emotional Intimacy',
  'inside-his-heart':  '💜 Inside His Heart',
  'desire-deck':       '🃏 Desire Deck',
  'pillow-talk':       '🌙 Pillow Talk',
  'couple-goals':      '✨ Couple Goals',
  'moment-i-knew':     '🌹 The Moment I Knew',
  'untold-truths':     '💫 Untold Truths',
  'our-forever':       '∞ Our Forever',
  'night-confessions': '🌙 Night Confessions',
  'first-times':       '💜 First Times',
  'words-i-hold':      '💌 Words I Hold',
